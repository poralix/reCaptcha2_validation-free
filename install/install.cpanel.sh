...
##############################################################################
#
#    reCAPTCHA VALIDATION FOR WordPress Login page $ v.0.2-Free (cPanel)
#
...
DIR_INSTALL="/usr/local/apache/htdocs/__captcha_validation_free-$(hostname | openssl md5 | sed 's/^.* //')";
